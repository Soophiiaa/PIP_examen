...
import 'package:pip_app/main.dart'; // Importa MainApp
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          Theme.of(context).colorScheme.primary, // Color de fondo primario
      body: Center(
        child: AnimatedOpacity(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'lib/assets/images/logo_pip.png', // Ruta de la imagen, recuerda la extensión
